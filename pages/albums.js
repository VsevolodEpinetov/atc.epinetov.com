        ...
        <div className={classes.container}>
          <GridContainer>
            ...
            >
              ...
              <h5 className={classes.description}>
                В некоторых изображениях присутствуют отметки в виде красного эллипса/прямоугольника. Ими обозначены особо проблемные зоны, на которые стоит обратить внимание. Квадратом обозначены зоны, где для обеспечения норм эшелонирования потребуется обеспечить вертикальный интервал, а в местах, отмеченных эллипсом - продольный.
              </h5>
            </GridItem>
            {
              albums.map(area => (
